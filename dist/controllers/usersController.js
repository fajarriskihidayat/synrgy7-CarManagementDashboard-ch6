...
exports.refreshToken = exports.logout = exports.getUser = exports.createAdmin = exports.loginSuperAdmin = exports.googleAuth = exports.login = exports.register = void 0;
...
const register = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield new userServise_1.default().getByEmail(payload.email);
    if (user)
...
const googleAuth = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let user = yield new userServise_1.default().getByEmail(data.email);
    if (!user) {
        const body = {
            name: data.name,
            email: data.email,
        ...
        user = yield new userServise_1.default().register(body);
    }
    const accessToken = (0, createToken_1.createToken)(user, process.env.ACCESS_TOKEN_SECRET, "15s");
    const refreshToken = (0, createToken_1.createToken)(user, process.env.REFRESH_TOKEN_SECRET, "1d");
    yield new userServise_1.default().updateToken(user.id, refreshToken);
